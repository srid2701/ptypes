...
def test_read(datadir):
    ...
    assert pytest.approx(par.AGE, 2.72e08)
    assert pytest.approx(par.RM, -2)
    assert pytest.approx(par.RM_ERR, 1.000e01)
    ...
    assert pytest.approx(par.AGE_I, 3.33e08)
    assert pytest.approx(par.BSURF_I, 1.88e12)
    assert pytest.approx(par.EDOT_I, 2.59e28)
    assert pytest.approx(par.EDOTD2, 1.2e30)
    ...
    assert pytest.approx(par.BSURF, 2.08e12)
    assert pytest.approx(par.B_LC, 3.16e-02)
    assert pytest.approx(par.SI414, 2.39)
    assert pytest.approx(par.EDOT, 3.2e28)
